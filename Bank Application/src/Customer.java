...
public abstract class Customer implements Serializable {
    ...
    private static int custId_gen = 99001;
    ...
    //The following method needs to be developed for all customers so that instead of using their full
    // tostring() in the Account information display, only a summary of the info will be used.  This summary
    // must display the customer's name, address and phone contact.
    ...
    public String customerSummary() {
        return String.format("Customer Info:\nName: %s %s\nAddress: %s\nPhone contact: %s",fname, lname, getAddress(), getContact());
    }
