<?php
include_once('../php/administrator_login_form_validation.php');
include_once('../php/client_subscribe_form_validation_subpage.php');
if(isset($_SESSION['auser'])){
  header("Location: ../php/administrator_main_dashboard.php"); 
  }
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
  ...
  <!-- Page Title -->
  <title>Ministry of Works and Transport - Administrator Login Page</title>
...
<body class="sub_page">
  ...
  <!-- administrator_login_section -->
  <section class="administrator_login_form_section layout_padding">
    <div class="container">
      <div class="row">
        <div class="col-2">
            ...
            <div class="administrator_login_form">
             
            <form
              id="administrator_login_form"
              method="post"
              action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>"
              onsubmit="return validate();" 
            >
            <img src="../icons/user_name.png" alt="User Name">
            <label for="administrator_user_name">User Name:</label>
            <input type="text" type="administrator_user_name" name="administrator_user_name" id="administrator_user_name" maxlength="15" required>
            <span id="administrator_user_name_err" class="validation_error"><?php echo $administrator_user_nameErr; ?></span><br>
            <img src="../icons/user_password.png" alt="User Password">
            <label for="administrator_user_password">Password:</label>
            <input type="password"  name="administrator_user_password" id="administrator_user_password"  maxlength="30" required>
            <span id="administrator_user_password_err" class="validation_error"><?php echo $administrator_user_passwordErr; ?></span><br>
            <input class="button_administrator_login" type="submit" name="submit_administrator_login" id="submit_administrator_login" value="Login" />
            </form>
  ...
  <!-- end administrator_login_section -->
...
<img src="../icons/telephone.png" alt="Telephone">
Arima:<a href="tel:1868-648-45-4535">1868-648-4535</a><br>

<img src="../icons/telephone.png" alt="Telephone">
Chag:<a href="1868-668-5537">1868-668-5537</a><br>
...
<!-- end social_footer_media_section -->
  ...
  <script src="../js/administrator_login_form_validation.js"></script>
