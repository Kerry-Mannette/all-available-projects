<?php
include_once('../php/client_subscribe_form_validation_subpage_two.php');
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
  ...
  <!-- Page Title -->
  <title>Ministry of Works and Transport - Login Page</title>
        ...
        <div class="col-2">
           ...
           <div class="login_information">
            <div class="client_login">
                <button onclick="window.location.href='client_login.php';"><b>Client Login</b>
                 <img src="../icons/client_login.png" alt="Client Login"> 
                </button>
            </div>

            <div class="staff_login">
              <button  onclick="window.location.href='staff_login.php';"><b>Staff Login</b>
               <img src="../icons/staff_login.png" alt="Staff Login"> 
              </button>
          </div>

            <div class="administrator_login">
                <button onclick="window.location.href='administrator_login.php';" ><b>Administrator Login</b>
                <img src="../icons/administrator_login.png" alt="Administrator Login">
              </button>  
