...
include_once('../php/staff_login_form_validation.php');
include_once('../php/client_subscribe_form_validation_subpage.php');
if(isset($_SESSION['suser'])){
  header("Location: ../php/staff_main_dashboard.php"); 
  }
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
  ...
  <!-- Page Title -->
  <title>Ministry of Works and Transport - Staff Login Page</title>
...
<body class="sub_page">
  ...
  <!-- staff_login_section -->
  <section class="staff_login_form_section layout_padding">
    <div class="container">
      <div class="row">
        <div class="col-2">
            ...
            <input type="text" type="staff_user_name" name="staff_user_name" id="staff_user_name" maxlength="15" required>
            <span id="staff_user_name_err" class="validation_error"><?php echo $staff_user_nameErr; ?></span><br>
            <img src="../icons/user_password.png" alt="User Password">
            <label for="staff_user_password">Password:</label>
            <input type="password"  name="staff_user_password" id="staff_user_password" maxlength="30" required>
            <span id="staff_user_password_err" class="validation_error"><?php echo $staff_user_passwordErr; ?></span><br>
            <input class="button_staff_login" type="submit" name="submit_staff_login" id="submit_staff_login" value="Login" />
            </form>
...
<!-- end social_footer_media_section -->
  ...
  <script src="../js/staff_login_form_validation.js"></script>
